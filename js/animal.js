  ...
  const i18n = {
    ...
    de: {
      ...
      result_label_cat: "Katzentyp"
        ...
        geo_def_desc: "Er analysiert ein Bild und zeigt einen Tiergesicht-Typ.",
        geo_how_title: "Wie funktioniert es?",
        geo_how_summary: "Folge diesen Schritten.",
        geo_how_step1: "Lade ein Bild hoch.",
        geo_how_step2: "Dr?cke ?Analysieren?, um Ergebnisse zu erzeugen.",
        geo_how_step3: "Pr?fe den angezeigten Typ und die Punktzahl.",
        geo_result_title: "Wie werden Ergebnisse angezeigt?",
        geo_result_desc: "Die Ergebnisse erscheinen als Typ und Punktzahl auf dem Bildschirm.",
        faq_title: "H?ufige Fragen (FAQ)",
        faq_summary: "Kurzantworten zum Tiergesicht-Test auf test-product-9ll.pages.dev.",
        faq_q1: "Q. Kann ich den Test ohne Foto machen?",
        faq_a1: "A. Ein Bild-Upload ist erforderlich.",
        faq_q2: "Q. Was bedeuten die Ergebnisse?",
        faq_a2: "A. Die Ergebnisse zeigen einen Referenz-Tiergesicht-Typ.",
        faq_q3: "Q. K?nnen Ergebnisse variieren?",
        faq_a3: "A. Ergebnisse k?nnen je nach Bild variieren.",
    },
    ja: {
      title: "動物顔テスト",
    ...
    en: {
      ...
      result_label_cat: "Cat face"
        ...
        geo_def_desc: "It analyzes an input image and shows an animal-face type.",
        geo_how_title: "How does it work?",
        geo_how_summary: "Follow these steps.",
        geo_how_step1: "Upload an image.",
        geo_how_step2: "Press analyze to generate results.",
        geo_how_step3: "Check the type and score shown.",
        geo_result_title: "How are results shown?",
        geo_result_desc: "Results are displayed as a type and score on the screen.",
        faq_title: "Frequently Asked Questions (FAQ)",
        faq_summary: "Key answers about the animal-face test on test-product-9ll.pages.dev.",
        faq_q1: "Q. Can I run the test without a photo?",
        faq_a1: "A. An image upload is required.",
        faq_q2: "Q. What do the results mean?",
        faq_a2: "A. Results show a reference animal-face type.",
        faq_q3: "Q. Can results change?",
        faq_a3: "A. Results may vary depending on the image.",
    }
  };
